...
import { RbacAssessmentReportReportChecksScope } from './RbacAssessmentReportReportChecksScope';
 ...
 * @export
 */
export interface RbacAssessmentReportReportChecks {
  /** category
   *
   * @required {false}
   */
   ...
   * @required {false}
   */
  scope?: RbacAssessmentReportReportChecksScope;
  /** severity
