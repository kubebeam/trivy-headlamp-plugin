...
import { InfraAssessmentReportReportChecksScope } from './InfraAssessmentReportReportChecksScope';
 ...
 * @export
 */
export interface InfraAssessmentReportReportChecks {
  /** category
   *
   * @required {false}
   */
   ...
   * @required {false}
   */
  scope?: InfraAssessmentReportReportChecksScope;
  /** severity
